...
export class CalcLangParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"file", "expr", "parentheses", "funcCall", "exprList", "identifierList",
	];
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(CalcLangParser._LITERAL_NAMES, CalcLangParser._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get serializedATN(): string { return CalcLangParser._serializedATN; }
	...
	public file(): FileContext {
		...
		try {
			...
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CalcLangParser.T__0) | (1 << CalcLangParser.T__1) | (1 << CalcLangParser.T__2) | (1 << CalcLangParser.T__3) | (1 << CalcLangParser.T__17) | (1 << CalcLangParser.Boolean) | (1 << CalcLangParser.Number) | (1 << CalcLangParser.Identifier))) !== 0)) {
				{
				this.state = 12;
				this.expr(0);
				this.state = 17;
	...
	public expr(_p?: number): ExprContext {
		...
		try {
			...
			case 3:
				...
				this.state = 33;
				_la = this._input.LA(1);
				if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CalcLangParser.T__0) | (1 << CalcLangParser.T__1) | (1 << CalcLangParser.T__2) | (1 << CalcLangParser.T__3))) !== 0))) {
			...
			case 7:
				...
				this.state = 52;
				_la = this._input.LA(1);
				if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CalcLangParser.Boolean) | (1 << CalcLangParser.Number) | (1 << CalcLangParser.Identifier))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 4:
						...
						this.state = 65;
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CalcLangParser.T__7) | (1 << CalcLangParser.T__8) | (1 << CalcLangParser.T__9) | (1 << CalcLangParser.T__10) | (1 << CalcLangParser.T__11) | (1 << CalcLangParser.T__12))) !== 0))) {
						this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
					...
					case 5:
						...
						this.state = 68;
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CalcLangParser.T__13) | (1 << CalcLangParser.T__14) | (1 << CalcLangParser.T__15) | (1 << CalcLangParser.T__16))) !== 0))) {
						this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
	...
	public static get _ATN(): ATN {
		if (!CalcLangParser.__ATN) {
			CalcLangParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(CalcLangParser._serializedATN));
		}
...
export class FileContext extends ParserRuleContext {
	public EOF(): TerminalNode { return this.getToken(CalcLangParser.EOF, 0); }
	public expr(): ExprContext[];
	...
	// @Override
	public get ruleIndex(): number { return CalcLangParser.RULE_file; }
	// @Override
...
export class ExprContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CalcLangParser.RULE_expr; }
...
export class ValueContext extends ExprContext {
	...
	public Identifier(): TerminalNode | undefined { return this.tryGetToken(CalcLangParser.Identifier, 0); }
	public Number(): TerminalNode | undefined { return this.tryGetToken(CalcLangParser.Number, 0); }
	public Boolean(): TerminalNode | undefined { return this.tryGetToken(CalcLangParser.Boolean, 0); }
...
export class ImplicitMulContext extends ExprContext {
	public Number(): TerminalNode { return this.getToken(CalcLangParser.Number, 0); }
	public funcCall(): FuncCallContext | undefined {
		return this.tryGetRuleContext(0, FuncCallContext);
	}
	public parentheses(): ParenthesesContext | undefined {
...
export class FuncAssignmentContext extends ExprContext {
	public Identifier(): TerminalNode { return this.getToken(CalcLangParser.Identifier, 0); }
	public expr(): ExprContext {
		return this.getRuleContext(0, ExprContext);
	}
...
export class ParenthesesContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CalcLangParser.RULE_parentheses; }
	// @Override
	public enterRule(listener: CalcLangListener): void {
...
export class FuncCallContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CalcLangParser.RULE_funcCall; }
	// @Override
	public enterRule(listener: CalcLangListener): void {
...
export class ExprListContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CalcLangParser.RULE_exprList; }
	// @Override
	public enterRule(listener: CalcLangListener): void {
...
export class IdentifierListContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CalcLangParser.RULE_identifierList; }
	// @Override
	public enterRule(listener: CalcLangListener): void {
